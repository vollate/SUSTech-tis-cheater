...
由于作者已经毕业，无法在每学期开始测试脚本是否可用。**建议有能力的同学在每学期开始抢课前提前测试可用性**，如果存在问题请提出issue或pr
...
**!!!注意**：自 2024 年秋季学期开始，学校对抢课频率进行了限制，最小请求间隔约为 1500ms（**此延时最后一次测试为24年9月，不保证时效性**）。考虑到网络波动，建议将间隔设置为 1600ms 或以上。
